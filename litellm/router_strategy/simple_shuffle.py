...
from litellm.types.router import validate_router_weights
...
def simple_shuffle(
    ...
    resolved_model: Final = resolve_model_group_alias(llm_router_instance.model_group_alias, model) or model
    ...
    for weights in weight_sets:
        ...
        verbose_router_logger.info("Selected deployment for model %s: %s", model, selected.get("model_info"))
        return selected
